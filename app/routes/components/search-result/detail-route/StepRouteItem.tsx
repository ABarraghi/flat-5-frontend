...
import ContactInfo from '@/app/routes/components/search-result/detail-route/ContactInfo';
...
import DetailDescription from '@/app/routes/components/search-result/detail-route/DetailDescription';
  ...
  return (
    <div className={cn('rounded-xl bg-[#F2F2F7] text-[#393978]')}>
      <div className="flex p-3 xl:p-6">
        <CarrierLogo name={brokerName} classNames="h-10 w-10 xl:h-14 xl:w-14" />
