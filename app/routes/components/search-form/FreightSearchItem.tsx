...
const MapboxSuggestion = dynamic(() => import('@/app/routes/components/search-form/MapboxSuggestion'), {
  ssr: false,
});

interface FreightSearchItemProps {
  name: string;
  index: number;
...
export default FreightSearchItem;
